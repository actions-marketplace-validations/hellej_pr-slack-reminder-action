	...
	testCases := []struct {
		...
		},
		{
			...
			expectedPRItemTexts: []string{
				...
				"🔧 This PR is getting old and needs attention 🚨 1 days ago 🚨 by U3234567890 (no reviews)",
				"🔧 This is a big PR that no one dares to review 🚨 2 days ago 🚨 by Jim (no reviews)",
			},
			expectedSummary: "5 open PRs are waiting for attention 👀",
		},
		{
			...
			expectedPRItemTexts: []string{
				...
				"Old PR needs attention 🚨 2 days ago 🚨 by Bob (no reviews)",
			},
			expectedSummary: "2 open PRs are waiting for attention 👀",
		},
		{
