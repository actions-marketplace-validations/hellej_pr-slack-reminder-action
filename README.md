...
| `pr-link-repo-prefixes`               | ❌       | Repository aliases to display as prefixes in PR link texts (e.g., "repo1: 'R1 / '; repo2: 'R2 / '"). Useful if group-by-repository is `false`.<br>Example:<br>`repo1: 🚀`<br>`repo2: 📦`               |
